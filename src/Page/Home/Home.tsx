...
import { sendChat } from "../../Axios Intandce/Call API";
        ...
        <div className="h-screen flex flex-col bg-gray-100">
            ...
            <div className="bg-white p-4 flex justify-between items-center shadow">
                ...
                <div className="relative group">
                    ...
                    >
                        ...
                        <div className="px-4 py-2 text-red-500 hover:bg-gray-100 cursor-pointer">⎋ Đăng xuất</div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-2">
                {messages.map((msg, index) => (
                    <div key={index} className={`flex ${msg.id == outletContext.data.account._id ? 'justify-end' : 'justify-start'}`}>
                        <div
            ...
            <div className="p-4 bg-white flex items-center gap-2">
                ...
                />
                <button onClick={sendMessage} className="bg-gray-600 text-white p-2 rounded hover:bg-gray-700">
